...
#include<iostream>
using namespace std;
//void StyleInfo::CMS_lumi( TPad* pad, int iPeriod, int iPosX ) {
void StyleInfo::CMS_lumi( TPad* pad, int iPosX, TString lumiText, TString extraText, float extraTextOff ) {
	//
	// Global variables
	//
